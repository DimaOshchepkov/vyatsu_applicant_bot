...
- Бот «помнит историю диалога между перезапусками благодаря RedisStorage.
...
Этот контейнер содержит Redis, Postgres, Qdarant. Настройку всех контейнеров вы можете увидеть в файле [docker-compose.yml](docker-compose.yml). Обратите внимание, что многие директории примонтированы для более удобной разработки.
